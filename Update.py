...
# Set the Google API key for embeddings
os.environ["GOOGLE_API_KEY"] = google_api_key

# Page title
st.title("Document Retrieval System :page_facing_up::mag:")
...
# Sidebar
with st.sidebar:
    st.title(":books: Document Retrieval System")
    st.markdown("""
        ## Features:
    ...
    """)
    st.write("Made with :heart: by Harshit")
